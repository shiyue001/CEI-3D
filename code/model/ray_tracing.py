...
class RayTracing(nn.Module):
    ...
    def forward(self,
        ...
        #batch_size, num_pixels, _=(1, 10000, 3)
        ...
        #sphere_intersections.shape--torch.Size([1, 10000, 2]); mask_intersect.shape--torch.Size([1, 10000])true or false to define whether it interacts with the sphere
        #curr_start_points--torch.Size([10000, 3]), other following paras are torch.Size([10000])
