...
def evaluate(**kwargs):
    ...
    ## implicit network
    # implicit_network_state = torch.load('/data2/code_backup/PhySG/code/geometry_editing/output/implicit_network_finetuned_2.pth')
    diffuse_albedo_layer_state = torch.load('/data2/code_backup/PhySG/code/geometry_editing/output/physg_bear/implicit_network_finetuned.pth')

    # for key, val in implicit_network_state['model_state_dict'].items():
    #     model_state_dict['implicit_network.'+key] = val

    # exit()

    for key, val in diffuse_albedo_layer_state['model_state_dict'].items():
        model_state_dict['envmap_material_network.'+key] = val
    ...
    # generate images
    images_dir = '/data2/code_backup/PhySG/code/geometry_editing/results/physg_bear'
