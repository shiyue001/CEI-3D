...
def get_surface_point_cloud(mesh, surface_point_method='sample', bounding_radius=None, scan_count=100, scan_resolution=400, sample_point_count=10000000, calculate_normals=True):
...
def sample_sdf_near_surface_with_sampling_pnts(mesh, sampling_pnts, number_of_points = 500000, surface_point_method='scan', sign_method='normal', scan_count=100, scan_resolution=400, sample_point_count=10000000, normal_sample_count=11, min_size=0, return_gradients=False):
    # mesh = scale_to_unit_sphere(mesh)
    ...
    return surface_point_cloud.sample_sdf_near_surface(number_of_points, surface_point_method=='scan', sign_method, normal_sample_count, min_size, return_gradients, sampling_pnts=sampling_pnts)
