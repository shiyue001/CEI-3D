...
from training.two_stage_training.idr_train_unedited_models import IDRTrainRunner
...
if __name__ == '__main__':
    ...
    ### idr training epochs
    parser.add_argument('--nepoch_idr', type=int, default=1000, help='number of epochs to train idr for')
