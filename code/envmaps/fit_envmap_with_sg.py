...
filename = '/data1/sr/code/PhySG/code/envmaps/envmap3.png'
filename = os.path.abspath(filename)
# gt_envmap = imageio.imread(filename)[1001:2000,1001:2000,:3].astype(np.float32)
gt_envmap = imageio.imread(filename).astype(np.float32) / 255.


print(gt_envmap.shape, gt_envmap.dtype)
